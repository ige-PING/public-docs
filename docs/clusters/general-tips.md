...
application is run remotely on the supercomputer but the GUI window(s) are opened locally on your own computer. This is
...
You can now launch GUI applications from the supercomputer.
